...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'pose_detection = manip_challenge.grasping.pose_detection:main',
            'path_planner = manip_challenge.grasping.path_planner:main',
            'home_robot = manip_challenge.grasping.home_robot:main',
            'rviz_visualizer = manip_challenge.grasping.rviz_visualizer:main',
            'rviz_visualizer_collider = manip_challenge.grasping.rviz_visualizer_collider:main',
            'gripper_control = manip_challenge.grasping.gripper_control:main',
            'record_grasp_pose = manip_challenge.grasping.record_grasp_pose:main',
            ],
    },
)
