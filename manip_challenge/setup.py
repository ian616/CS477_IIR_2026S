...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'rviz_visualizer = manip_challenge.custom.grasping.rviz_visualizer:main',
            'rviz_visualizer_collider = manip_challenge.custom.grasping.rviz_visualizer_collider:main',
