...
MESHES = {
    'coke_can': 'package://manip_challenge/data/models/coke_can/meshes/coke_can.dae',
    'strawberry': 'package://manip_challenge/data/models/strawberry/textured.dae',
    'meat_can': 'package://manip_challenge/data/models/meat_can/textured.dae',
    'hammer': 'package://manip_challenge/data/models/hammer/meshes/hammer.dae',
    'banana': 'package://manip_challenge/data/models/banana/meshes/Banana.dae',
    'eraser': 'package://manip_challenge/data/models/eraser/meshes/eraser_aligned.dae',
    'mustard_bottle': 'package://manip_challenge/data/models/mustard_bottle/textured.dae',
    'glue': 'package://manip_challenge/data/models/glue/meshes/glue_aligned.dae',
    'snacks': 'package://manip_challenge/data/models/snacks/meshes/snacks_aligned.dae',
    'book': 'package://manip_challenge/data/models/book/meshes/book_aligned.dae',
    'soap': 'package://manip_challenge/data/models/soap/meshes/soap_aligned.dae',
    'soap2': 'package://manip_challenge/data/models/soap2/meshes/soap2_aligned.dae',
    'biscuits': 'package://manip_challenge/data/models/biscuits/meshes/biscuits_aligned.dae'
}
...
class RVizVisualizer(Node):
    ...
    def world_model_callback(self, msg):
        ...
        for idx, obj in enumerate(world_objects):
            ...
            mesh_path = MESHES[base_model_name]
            
            # Publish a MESH marker for the exact 3D visual model
            marker = Marker()
            
            # Use 'base_link' as the frame_id since Gazebo coordinates perfectly align with the robot base
            marker.header.frame_id = 'base_link' 
            marker.header.stamp = self.get_clock().now().to_msg()
            marker.ns = "gazebo_visuals"
            ...
            # For 3D meshes, the origin is already at the base exactly like the TF frame, so NO z-offset is needed!
            marker.pose.position.x = float(x)
            marker.pose.position.y = float(y)
            marker.pose.position.z = float(z) - 0.6
            ...
            # Set scale to 1:1 since the Mesh is naturally scaled
            marker.scale.x = 1.0
            marker.scale.y = 1.0
            marker.scale.z = 1.0
            
            # Solid color fallback if materials fail
            marker.color.a = 1.0
            marker.color.r = 1.0
            marker.color.g = 1.0
            marker.color.b = 1.0
